...
const GameDetail = () => {
    ...
    return (
        <div id='outlet' className='flex flex-col w-full'>
            ...
            <div className='w-full flex items-center justify-between'>
                <div 
                    className='absolute flex items-center rounded-lg select-none justify-center h-[100px] w-[40px] border-[2px] border-gray-400 text-gray-500 hover:border-white hover:text-white cursor-pointer'
                    onClick={handlePrevImage}
                ><FaChevronLeft size={30}/></div>
                <div 
                    className='absolute flex items-center rounded-lg select-none justify-center h-[100px] w-[40px] border-[2px] border-gray-400 text-gray-500 hover:border-white hover:text-white cursor-pointer'
                    style={{
                        marginLeft: `${outletWidth - 40}px`
                    }}
